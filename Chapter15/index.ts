...
console.log(f1<number>(42));          // Works with number, outputs: 42
console.log(f1<string>("name"));      // Works with string, outputs: "name"
console.log(f1<boolean>(true));       // Works with boolean, outputs: true
...
function add<T>(a: T, b: T): T {
    ...
    if (typeof a === "number" && typeof b === "number") {
        return (a + b) as T; // Works for numbers
    } else if (typeof a === "string" && typeof b === "string") {
        return (a + b) as T; // Works for strings
    } else {
...
console.log(add<number>(5, 10));                // Outputs: 15
console.log(add<string>("Rohit", " Kumar"));    // Outputs: "Rohit Kumar"
...
console.log(getArrayLength<number>([1, 2, 3, 4]));   // Outputs: 4
console.log(getArrayLength<string>(["a", "b", "c"])); // Outputs: 3
...
function addi<T, U, V>(a: T, b: U, c: V): void {
...
addi<number, string, boolean>(5, "Rohit", true); // Outputs: "number", "string", "boolean"
addi<string, boolean, number>("Rohit", true, 5); // Outputs: "string", "boolean", "number"
