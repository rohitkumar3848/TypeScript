...
let str='Rohit';// The compiler infers the type string for the variable name.
...
function mul(x:number,y:number):number{ //Infer the return type of the function using number type in inference.
    return x*y;
}
